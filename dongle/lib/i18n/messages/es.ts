...
export const es: Messages = {
  ...
  analytics: {
    ...
    formSubmissions: {
      title: "Análisis de Envío de Formularios",
      subtitle: "Realiza un seguimiento del compromiso, errores y tasas de finalización de los formularios.",
      totalSubmissions: "Total de Envíos",
      errorRate: "Tasa de Error",
      abandonmentRate: "Tasa de Abandono",
      fieldCompletion: "Finalización Promedio de Campos",
      submissionCountByPeriod: "Conteo de Envíos por Período",
      submissions: "Envíos",
      fieldCompletionRates: "Tasas de Finalización de Campos",
    },
    backupRecovery: {
      title: "Backup y Recuperación de Formularios",
      subtitle: "Administra los backups automáticos y restaura datos.",
      backupEnabled: "Backups automáticos habilitados",
      backupDisabled: "Backups automáticos deshabilitados",
      ...
      restoreFrom: "Restaurar desde backup #{id}",
      restoreConfirm: "¿Estás seguro de que deseas restaurar este backup? Los datos actuales del formulario serán reemplazados.",
      restoreSuccess: "Datos del formulario restaurados desde el backup.",
      restoreFailed: "Error al restaurar el backup.",
      deleteBackup: "Eliminar backup",
      deleteConfirm: "¿Estás seguro de que deseas eliminar este backup?",
      deleteSuccess: "Backup eliminado.",
      deleteFailed: "Error al eliminar el backup.",
      noBackups: "No hay backups disponibles.",
      backupCreated: "Backup creado.",
      backupFailed: "Error en el backup.",
      retentionCleaned: "Limpiar backups expirados",
      lastBackup: "Último backup: {date}",
      backupCount: "{count} backup(s)",
      configTitle: "Configuración de Backup",
      configSaved: "Configuración de backup guardada.",
      configReset: "Restablecer valores predeterminados",
      justNow: "ahora mismo",
    ...
    formArchive: {
      title: "Archivo de Datos de Formulario",
      subtitle: "Gestiona envíos archivados para cumplimiento.",
      archivePolicy: "Política de Archivo",
      archiveAfter: "Archivar backups más antiguos que",
      maxArchivedBackups: "Máximo de backups archivados",
      maxArchivedAge: "Edad máxima del archivo",
      automatedArchival: "Archivado automático",
      automatedArchivalEnabled: "Archivado automático habilitado",
      automatedArchivalDisabled: "Archivado automático deshabilitado",
      archivedBackups: "Backups Archivados",
      searchPlaceholder: "Buscar backups archivados...",
      searchResults: "{count} resultado(s) encontrado(s)",
      noArchivedBackups: "Ningún backup archivado.",
      archivedAt: "Archivado el {date}",
      archivedBy: "Archivado por {reason}",
      restoreFromArchive: "Restaurar desde archivo",
      restoreFromArchiveConfirm: "¿Estás seguro de que deseas restaurar este backup archivado? Los datos actuales serán reemplazados.",
      restoreFromArchiveSuccess: "Datos restaurados desde el archivo.",
      restoreFromArchiveFailed: "Error al restaurar el backup archivado.",
      deleteArchivedBackup: "Eliminar backup archivado",
      deleteArchivedConfirm: "¿Estás seguro de que deseas eliminar este backup archivado? Esta acción no se puede deshacer.",
      deleteArchivedSuccess: "Backup archivado eliminado.",
      deleteArchivedFailed: "Error al eliminar el backup archivado.",
      cleanExpiredArchived: "Limpiar backups archivados expirados",
      archiveRetentionCleaned: "Retención de archivo limpia: {removed} eliminado(s), {remaining} restante(s).",
      lastArchived: "Último archivo: {date}",
      archivedCount: "{count} backup(s) archivado(s)",
      configTitle: "Configuración del Archivo",
      configSaved: "Configuración del archivo guardada.",
      configReset: "Restablecer valores predeterminados",
      archiveNow: "Archivar backups antiguos ahora",
      archivingComplete: "Archivado completado: {count} backup(s) archivado(s).",
      archivalRunning: "Ejecutando archivado automático...",
      justNow: "ahora mismo",
      minutesAgo: "{count} min.",
      hoursAgo: "{count} hr.",
      daysAgo: "{count} día(s)",
