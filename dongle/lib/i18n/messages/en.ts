...
export const en = {
  ...
  twofa: {
    ...
    description: "Add an extra layer of security to your account by requiring a verification code in addition to your wallet connection.",
    status: "2FA Status",
    enabled: "Two-factor authentication is active",
    disabled: "Two-factor authentication is disabled",
    enable: "Enable 2FA",
    disable: "Disable 2FA",
    disableConfirm: "Disabling two-factor authentication will remove all configured methods and backup codes.",
    requireForSubmissions: "Require for form submissions",
    requireForSubmissionsHint: "When enabled, 2FA verification will be required when submitting forms",
    smsTitle: "SMS Verification",
    emailTitle: "Email Verification",
    totpTitle: "Authenticator App (TOTP)",
    backupCodesTitle: "Backup Codes",
    backupCodesHint: "Use a backup code if you lose access to your other methods",
    ...
    totpSetupSteps: "1. Open your authenticator app\n2. Tap 'Add' and select 'Enter a setup key'\n3. Paste the secret key\n4. Enter the 6-digit code to verify",
    backupCodesUnused: "{count} unused code{plural}",
    backupCodesUsed: "{count} used code{plural}",
    backupCodesWarning: "Store these codes securely. Each code can only be used once.",
    regenerateCodes: "Regenerate Codes",
    regenerateConfirm: "Regenerating backup codes will invalidate all existing codes. Continue?",
    copyCodes: "Copy all codes",
    codesCopied: "Backup codes copied to clipboard",
    noBackupCodes: "No backup codes generated yet.",
    generateBackupCodes: "Generate Backup Codes",
    methodSMS: "SMS Code",
    methodEmail: "Email Code",
    methodTOTP: "Authenticator App",
    methodBackupCode: "Backup Code",
    chooseMethod: "Choose a verification method:",
    codeSent: "Verification code sent to {target}",
    resendCode: "Resend code",
    verificationSuccess: "Verification successful",
    verificationFailed: "Verification failed. Please try again.",
    tooManyAttempts: "Too many attempts. Please try again.",
    noSession: "No verification code was sent. Please request a new one.",
    invalidCode: "Invalid verification code. Please try again.",
    totpNotConfigured: "TOTP is not configured.",
    invalidBackupCode: "Invalid or already used backup code.",
    unknownMethod: "Unknown verification method.",
    totpEnabled: "TOTP authentication enabled successfully",
    smsEnabled: "SMS verification enabled",
    emailEnabled: "Email verification enabled",
    twofaEnabled: "Two-factor authentication enabled",
    twofaDisabled: "Two-factor authentication disabled",
    submissionRequirementOn: "2FA required for form submissions",
    submissionRequirementOff: "2FA no longer required for form submissions",
  },
} as const;
